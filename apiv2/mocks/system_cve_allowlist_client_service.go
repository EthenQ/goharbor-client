...
import (
	...
	system_cve_allowlist "github.com/ethenq/goharbor-client/v5/apiv2/internal/api/client/system_cve_allowlist"
)
...
type mockConstructorTestingTNewMockSystem_cve_allowlistClientService interface {
	mock.TestingT
	Cleanup(func())
}
