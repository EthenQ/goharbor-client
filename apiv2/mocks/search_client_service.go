...
import (
	...
	search "github.com/ethenq/goharbor-client/v5/apiv2/internal/api/client/search"
)
...
type mockConstructorTestingTNewMockSearchClientService interface {
	mock.TestingT
	Cleanup(func())
}
