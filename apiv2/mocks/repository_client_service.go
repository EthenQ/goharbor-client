...
import (
	...
	repository "github.com/ethenq/goharbor-client/v5/apiv2/internal/api/client/repository"
...
func (_m *MockRepositoryClientService) ListAllRepositories(params *repository.ListAllRepositoriesParams, authInfo runtime.ClientAuthInfoWriter) (*repository.ListAllRepositoriesOK, error) {
	...
	var r0 *repository.ListAllRepositoriesOK
	if rf, ok := ret.Get(0).(func(*repository.ListAllRepositoriesParams, runtime.ClientAuthInfoWriter) *repository.ListAllRepositoriesOK); ok {
		r0 = rf(params, authInfo)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*repository.ListAllRepositoriesOK)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*repository.ListAllRepositoriesParams, runtime.ClientAuthInfoWriter) error); ok {
		r1 = rf(params, authInfo)
	} else {
		r1 = ret.Error(1)
	}
...
type mockConstructorTestingTNewMockRepositoryClientService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRepositoryClientService(t mockConstructorTestingTNewMockRepositoryClientService) *MockRepositoryClientService {
	mock := &MockRepositoryClientService{}
	mock.Mock.Test(t)
