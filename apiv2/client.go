...
import (
	...
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/configure"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/ping"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/statistic"

	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/purge"

	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/label"

	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/artifact"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/repository"

	"k8s.io/apimachinery/pkg/util/intstr"

	modelv2 "github.com/ethenq/goharbor-client/v5/apiv2/model"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/auditlog"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/gc"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/health"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/member"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/projectmeta"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/quota"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/retention"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/robot"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/robotv1"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/webhook"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/common"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/config"

	"github.com/go-openapi/runtime"
	runtimeclient "github.com/go-openapi/runtime/client"
	"github.com/go-openapi/strfmt"

	v2client "github.com/ethenq/goharbor-client/v5/apiv2/internal/api/client"

	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/project"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/registry"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/replication"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/systeminfo"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/clients/user"
)
...
func NewRESTClientForHost(u, username, password string, opts *config.Options) (*RESTClient, error) {
	...
	var v2SwaggerClient *v2client.Harbor
