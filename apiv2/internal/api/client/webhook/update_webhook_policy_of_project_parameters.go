...
func (o *UpdateWebhookPolicyOfProjectParams) WithPolicy(policy *model.WebhookPolicy) *UpdateWebhookPolicyOfProjectParams {
	o.SetPolicy(policy)
	return o
}

// SetPolicy adds the policy to the update webhook policy of project params
func (o *UpdateWebhookPolicyOfProjectParams) SetPolicy(policy *model.WebhookPolicy) {
	o.Policy = policy
}
