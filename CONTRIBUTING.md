...
import (
	...
	"github.com/ethenq/goharbor-client/v5/apiv2/internal/api/client/user"
	modelv2 "github.com/ethenq/goharbor-client/v5/apiv2/model"
	"github.com/ethenq/goharbor-client/v5/apiv2/pkg/config"
	clienterrors "github.com/ethenq/goharbor-client/v5/apiv2/pkg/errors"
...
The package also contains a [`Client` interface](https://github.com/ethenq/goharbor-client/blob/master/apiv2/user/user.go#L36) that holds all method signatures:
```go
...
To make the sub-client's methods accessible via the `github.com/ethenq/goharbor-client/apiv2` package, 
